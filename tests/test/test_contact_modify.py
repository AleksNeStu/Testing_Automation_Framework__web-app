...
test_data = [Contact(first_name=r_data(data.CONTACT_FIRST_NAME_NEW),
                     ...
                     email=r_email(data.CONTACT_EMAIL))] + [Contact()]
...
def test_modify_some_contact(app, new_contact):
    ...
    app.contact.modify_contact_via_home(ind, new_contact)
